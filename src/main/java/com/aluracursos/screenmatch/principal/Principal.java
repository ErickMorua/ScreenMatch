...
public class Principal {
    ...
    private final String API_KEY = "&apikey=a78c8ee5";
    ...
    private void buscarTop5Series() {
        ...
        topSeries.forEach(s -> System.out.println("Series: "+ s.getTitulo() + "Evaluacion: " + s.getEvaluacion()) );
    }
    ...
    private void filtrarSeriesPorTemporadaYEvaluacion() {
        ...
        teclado.nextLine();
        List<Serie> filtroSeries = repository.seriesPorTemporadaYEvaluacion(totalDeTemporadas, evaluacion);
    ...
    private void buscarEpisodioPorTitulo() {
        System.out.println("Esxribe el nombre del episodio que deseas buscar");
        var nombreEpisodio = teclado.nextLine();
        List<Episodio> episodiosEncontrados = repository.episodiosPorNombre(nombreEpisodio);
        episodiosEncontrados.forEach(e ->
                System.out.printf("Series: %s Temporada %s Episodio %s Evaluación %s\n",
